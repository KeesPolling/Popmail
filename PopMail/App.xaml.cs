...
namespace PopMail
{
    ...
    sealed partial class App : PrismUnityApplication
    {
        ...
        protected override Task OnInitializeAsync(IActivatedEventArgs args)
        {
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "PopMail.UILogic.ViewModels.{0}ViewModel, AdventureWorks.UILogic, Version=1.1.0.0, Culture=neutral", viewType.Name);
